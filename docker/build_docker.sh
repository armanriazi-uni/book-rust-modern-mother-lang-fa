...
### that is capable of building and running book-rust-modern-mother-lang-to-fa.
...
RUSTC_VERSION=$(cat ${book-rust-modern-mother-lang-to-fa_BASE_DIR}/rust-toolchain)
